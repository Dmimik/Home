...
const validateField = (value, { label, maxLength }) => {
...
const NOTE_FIELD_RULES = [
  { field: "title", label: "Title", maxLength: 200 },
  { field: "content", label: "Content", maxLength: 10000 },
];

exports.validateNote = (req, res, next) => {
  const firstError = NOTE_FIELD_RULES.map((rule) =>
    validateField(req.body[rule.field], rule)
  ).find(Boolean);
